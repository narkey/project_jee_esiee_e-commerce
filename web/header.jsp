 	...
 	<c:if test="${sessionScope.sessionUtilisateur.access < 2}">
 		<li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="disabled"><a href="SupprimerRef"><span class="glyphicon glyphicon-minus"></span>&nbsp;&nbsp;Supprimer une r&eacute;f&eacute;rence</a></li>
            <li class="disabled"><a href="ModifierRef"><span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp;Modifier une r&eacute;f&eacute;rence</a></li>
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a href="Confirmation"><span class="glyphicon glyphicon-circle-arrow-right"></span>&nbsp;&nbsp;Passer ma commande</a></li>
        </ul>
      </li>
